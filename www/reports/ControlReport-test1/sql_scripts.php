<?php
	...
	$ProductCategory = "
	  nvl((
	     SELECT t.kod_category 
	       FROM xx_raport_category t
          where t.nsi008_id=MS003.NSI008_ID
	  ),'666')
	"
	/*	
	$ProductCategory = "
		CASE
			...
			(case when REF020.NAME like '%КАССА%' then 122 else 46 end )
...
/*case when REF020.NAME like '%КАССА%' then 45 else 46 end*/
	...
	"
	  nvl((
		 SELECT decode(t.kod_fcategory,999,666,t.kod_fcategory) 
	     FROM xx_raport_category t
         where t.nsi008_id=FIRST_MS002.NSI008_ID
	  ),'666')
	"
