<?php
  ...
  /*
      ...
      echo $key . " = " . $value[0] . ", " . $value[1] . ", " . $value[2] . ", " . $value[3] . ", " . $value[4] . ", " . $value[5] . ", " . $value[6] . ", " . $value[7] . ", " . $value[8] . ", " . $value[9] . "<br>";
      }
  	
  	  foreach ($cell as $key => $value) {
      echo $key . " = " . $value[0] . ", " . $value[1] . ", " . $value[2] . ", " . $value[3] . ", " . $value[4] . ", " . $value[5] . ", " . $value[6] . ", " . $value[7] . ", " .
						$value[8] . ", " . $value[9] . ", " . $value[10] . ", " . $value[11] . ", " . $value[12] . ", " . $value[13] .", " . $value[14] ."<br>";
      }
 */
...
/*		
		echo "----------------" .$sql ."---------------" . '<br>' ;
 	    for ($i = 0; $i < $rows; $i++) {
        echo $i . " = " . $result["CAR_COUNT"][$i] . ", " . $result["CAR_WALKING_ID"][$i] . ", " . $result["CAR_TYPE_ID"][$i] . ", " .
						$result["WEIGHT_SIGN"][$i] . ", " . $result["ORGANIZATION_ID"][$i] . ", " . $result["UNIT_TYPE_CODE"][$i] . ", " .
						$result["ACTION_TYPE"][$i] . ", " . $result["CAR_OWNER_SIGN"][$i] . ", " . $result["UNIT_LENGTH"][$i] . ", " . 
						$result["CARGO_CATEGORY_ID"][$i] . ", " . $result["FWEIGHT_SIGN"][$i] . ", " . $result["FCARGO_CATEGORY_ID"][$i] ."<br>";
        }
*/
                ...
                for ($i = 0; $i < $rows; $i++) {
					...
					if (($value[0] == "NIL"  || $result["CAR_TYPE_ID"][$i]        == $value[0]) &&
						...
						($value[6] == "NIL"  || $result["ACTION_TYPE"][$i]        == $value[6])
					      ...
					      if ($ii == 168) { echo "----". $value[1] . "," . $value[12] ."----" . $i 
														. ", " . $result["CAR_COUNT"][$i]
														. ", " . $result["CAR_WALKING_ID"][$i] . " @ " . $value[3]
														. ", " . $result["CAR_TYPE_ID"][$i] . " @ " . $value[0]
														. ", " . $result["WEIGHT_SIGN"][$i] . " @ " . $value[2]
														. ", " . $result["ORGANIZATION_ID"][$i] . " @ " . $value[1]
														. ", " . $result["UNIT_TYPE_CODE"][$i] . " @ " . $value[5]
														. ", " . $result["ACTION_TYPE"][$i] . " @ " . $value[6]
														. ", " . $result["CAR_OWNER_SIGN"][$i] . " @ " . $value[4]
														. ", " . $result["UNIT_LENGTH"][$i] . " @ " . $value[11]
														. ", " . $result["CARGO_CATEGORY_ID"][$i] . " @ " . $value[7]
														
														. ", " . $result["FWEIGHT_SIGN"][$i] . " @ " . $value[13]
														. ", " . $result["FCARGO_CATEGORY_ID"][$i] . " @ " . $value[14]
