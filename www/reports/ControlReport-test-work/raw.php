<?php
	...
	$row = 0;
	$result = "";
	$column_count = /*20*/21; // Кол-во колонок
	...
	foreach (array("$sql_10", "$sql_11", "$sql_10", "$sql_11", "$sql_12") as $sql) {
        ...
        for ($i = 0; $i < $p; $i++) {
            for ($j = 0; $j < $column_count; $j++) {
				...
				if ($j == 1 || $j == 3 || $j == 5 || $j == 7 || $j == 10 || $j == 12 || $j == /*14*/15 || $j == /*16*/17 || $j == /*18*/19) {$ownSign = "СОБ";}
				else if ($j == 2 || $j == 4 || $j == 6 || $j == 8 || $j == 11 || $j == /*13*/14 || $j == /*15*/16 || $j == /*17*/18 || $j == /*19*/20) {$ownSign = "ЧУЖ";}
				else {$ownSign = "";}
				
                if ($j == 3 || $j == 4 || $j == /*16*/17 || $j == /*17*/18) {$actType = "ПОДАНО";}
                else if ($j == 5 || $j == 6) {$actType = "ВЫГР";}
                else if ($j == 7 || $j == 8) {$actType = "СДАНО";}
                else if ($j == 12 || $j == /*13*/14) {$actType = "ПОД_ВЫГР";}
                else {$actType = "";}
				
                if ($j == 0 || $j == 1 || $j == 2 || $j == 9 || $j == 10 || $j == 11) {$weiSign = "1";}
                else if ($j == /*14*/15 || $j == /*15*/16) {$weiSign = "0";}
                else {$weiSign = "";}
				
                if (($sql_count == 10 && $j >= 0 && $j <= 2) ||
                    ($sql_count == 11 && $j >= 3 && $j <= 8) ||
                    ($sql_count == 12 && $j >= 9 && $j <= /*15*/16) ||
                    ($sql_count == 13 && $j >= /*16*/17 && $j <= /*17*/18) ||
                    ($sql_count == 14 && $j >= /*18*/19 && $j <= /*19*/20))
                {
                    $count = 0;
                    for ($k = 0; $k < $row; $k++) {
