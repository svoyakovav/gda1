...
/**/						"UNIT.CONT_LOCATION* Расположение *width=\"150\" align=\"left\"",			
...
/**/						"UNIT.CONT_LOCATION* Расположение *width=\"150\" align=\"left\"",							
							...
							"UNIT.CAR_BELONG*Принадлежность <br> вагона *align=\"left\" width=\"160\"");
			break;
		case "ПС_СДАНО_ПОРОЖ":
			$column = array("UNIT.CAR_NUMBER*Номер<br>единицы*width=\"70\"",
...
/**/						"UNIT.CONT_LOCATION* Расположение *width=\"150\" align=\"left\"",			
							...
							"UNIT.SHIPPER_NAME*Грузоотправитель*align=\"left\" width=\"180\"",
							"UNIT.CAR_OWNER_SIGN*Грузоотправитель*align=\"left\" width=\"180\"",
							"UNIT.CAR_BELONG*Принадлежность <br> вагона *align=\"left\" width=\"160\"");
			break;
		case "ПС_В_ОТСТОЕ":
			$column = array("UNIT.CAR_NUMBER*Номер<br>единицы*width=\"70\"",
...
/**/						"UNIT.CONT_LOCATION* Расположение *width=\"150\" align=\"left\"",			
		...
		case "ПС_ПУСТО":
			$column = array("UNIT.CAR_NUMBER*Номер<br>единицы*width=\"70\"",
		/*				    "UNIT.FCARGO_CATEGORY_ID*категория1*width=\"70\"",
		                    "UNIT.CARGO_CATEGORY_ID*категория1*width=\"70\"",
							"UNIT.UNIT_TYPE_CODE*TYPE_CODE*width=\"70\"",
		 					"UNIT.UNIT_LENGTH*LENGTH*width=\"70\"", 
*/
/**/						"UNIT.CONT_LOCATION* Расположение *width=\"150\" align=\"left\"",	
							"UNIT.CARGO_FULL_NAME*Номенклатура предприятия (либо ЕТСНГ)*align=\"left\" width=\"320\"",
							"UNIT.CARGO_WEIGHT_NETTO*Вес груза<br>нетто (т)*align=\"right\"",
							"UNIT.SHIPPER_NAME*Грузоотправитель*align=\"left\" width=\"180\"",
							"UNIT.CAR_BELONG*Принадлежность <br> вагона *align=\"left\" width=\"160\"");
		...
		case "С_ПОД_ВЫГР":
			$column = array("UNIT.CAR_NUMBER*Номер<br>единицы*width=\"70\"",
/*20180228 elt*/			"UNIT.COMING_DATE*Дата прибытия*width=\"100\"",			
...
/*20180228 elt*/			"UNIT.COMING_DATE*Дата прибытия*width=\"100\"",
		...
		case "С_ГРУЖ":
			$column = array("UNIT.CAR_NUMBER*Номер<br>единицы*width=\"70\"",
		/*	                "UNIT.FCARGO_CATEGORY_ID*категория1*width=\"70\"",
							"UNIT.UNIT_TYPE_CODE*категория*width=\"70\"",
		*/					"UNIT.COMING_DATE*Дата прибытия*width=\"100\"",
							"UNIT.SHIPPER_NAME*Грузоотправитель*align=\"left\" width=\"230\"",
							"UNIT.DEPARTURE_STATION_NAME*Станция<br>отправления*align=\"left\" width=\"100\"",
							"UNIT.FCARGO_WEIGHT_NETTO*Вес сырья<br>нетто (т)*align=\"right\"");
	...
	for ($i = 0; $i < $count; $i++) {
		...
		$header = $header . "<th bgcolor=\"#FFDEAD\">" . $arr[1] . "</th>";
			...
			//and UNIT.CAR_NUMBER is not null
	$sql_current = "
		SELECT " . $select . "
