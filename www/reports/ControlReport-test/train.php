...
/*	 14/12/2018 ELT удаление таблицы выгрузка		
							// ---- RAW ----- \\
		array("<th colspan=\"2\" bgcolor=\"#cccccc\">Итого</th>", "RAW_HEADER",
			...
			//--------
		array("<th colspan=\"2\"><br> Бензол</th>", "RAW_LINE",
			"NIL", "NIL", "NIL", "NIL", "NIL", "NIL", "NIL", "45"),
		array("<th colspan=\"2\">Фенол<br></th>", "RAW_LINE",
...
/*  14/12/2018 ELT удаление таблицы выгрузка				
			if ($btype == "RAW") {
 			...
 			if ($btype == "TRN") {
				...
				if ($ltype == "HEADER") {
					switch ($j) {
						/*case 4: коммент*/ case /*18*/19: $cell[$p][0] = "0"; break;
						default: $cell[$p][0] = $line[$i][2]; break;}
				} else if ($ltype == "WITHOUT") {
					switch ($j) {
						case 0: case 1: case 9: case 10: case 11: case 12: /*case 13:*/ case 14: case 15: case 16: case 17:/*ins*/case 18: case /*20*/21: $cell[$p][0] = $line[$i][2]; break;
						default: $cell[$p][0] = "0"; break;}
				} else if ($ltype == "LINE") {
					switch ($j) {
						case 2: case 3: /*case 4:*/ case 5: case /*18*/19: case /*19*/20: $cell[$p][0] = "0"; break;
						default: $cell[$p][0] = $line[$i][2]; break;}
				}
				...
				// WEIGHT_SIGN (0 - Порожний; 1 - Груженый)
				switch ($j) {
					case 1: case 3: /*нов*/case 4: case 8: case 9: case 10: case 11: case 12: case /*20*/21: $cell[$p][2] = "1"; break;
					case 2: case 5: /*case 13: */case 14: case 15: case 16: case 17: /*ins*/case 18: case /*19*/20: $cell[$p][2] = "0"; break;
					default: $cell[$p][2] = "NIL"; break;
				}
				
				// ACTION_TYPE
				switch ($j) {
					case 2: case 3: case /*19*/20: $cell[$p][6] = "РЕГИСТР"; break;
					/*нов*/case 4: case 5: case 8: case /*20*/21: $cell[$p][6] = "ПРИЕМ_СОСТ"; break;
...
/*18-12-2018*/		case 13: $cell[$p][6] = "ПОД_ВЫГР"; break;
					case /*14*/15: $cell[$p][6] = "ПОД_ПОГР"; break;
					case /*15*/16: $cell[$p][6] = "ГОТ_ПОГР"; break;
					case /*16*/17: $cell[$p][6] = "В_ОТСТ"; break;
					case /*17*/18: $cell[$p][6] = "БРАК"; break;
					default: $cell[$p][6] = "NIL"; break;
				}
				// SQL_NUMBER
				if ($j >= 9 && $j <= /*17*/18) {$cell[$p][10] = "3";}
				else if ($j >= /*19*/20 && $j <= /*20*/21) {$cell[$p][10] = "4";}
...
/*нов */		    case 4: $cell[$p][12] = "ПС_СДАНО_ГРУЖ"; break;
					case 5: $cell[$p][12] = "ПС_СДАНО_ПОРОЖ"; break;   
					case 8: 
					case 20: $cell[$p][12] = "ПС_ОФОРМ"; break;
...
/*18-12-2018*/		case 13: $cell[$p][12] = "С_ПОД_ВЫГР"; break;
					case /*13*/14: $cell[$p][12] = "ПС_ПОРОЖ_ВСЕГО"; break;
					case /*14*/15: $cell[$p][12] = "ПС_ПОД_ПОГР"; break;
					case /*15*/16: $cell[$p][12] = "ПС_ГОТ_ПОГР"; break;
					case /*16*/18: $cell[$p][12] = "ПС_В_ОТСТОЕ"; break;
					case /*17*/18: $cell[$p][12] = "ПС_БРАК"; break;
...
//						($value[20] == "NIL" || $result["cont_location"][$i]      == $value[20]) &&
