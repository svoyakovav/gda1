...
<html>
	<head>
		...
		<title>Рапорт диспетчера TEST2</title>

		<link type="text/css" href="/libraryes/dataTables/jquery-ui-1.12.1.custom/jquery-ui.min.css" rel="stylesheet">

		<script type="text/javascript" src="/libraryes/dataTables/jquery-3.3.1.js"></script>

		<script type="text/javascript" src="/libraryes/dataTables/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
