...
// ---------------------------
set_time_limit(90); // Лимит времени ожидания ответа от сервера (сек)
...
if ($conn = OCILogon("xx_user", "xx_user2016", $sid, "UTF8"))
 {
  ...
  $pdf->SetXY(20, 8);
  $pdf->Cell(170, 6, "Проверочная ведомость №" . $invoice_number . " от " . "07.06.18 12:45" /*date("d.m.y H:i")*/ . " на вывод", 0, 0, 'C', 0);
  $pdf->ln();
  $pdf->SetX(20);
